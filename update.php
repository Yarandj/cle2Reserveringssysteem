                ...
                <div class="w-full p-6">
                    ...
                    <section class="columns">
                        ...
                        if(isset($_GET['id']))
                            ...
                            $query = "SELECT reservations.id, reservations.name, reservations.email, 
                                            reservations.telephone, reservations.time, reservations.date, treatments.treatment_id, treatments.kind 
                                    FROM reservations INNER JOIN treatments ON reservations.treatment_id = treatments.treatment_id WHERE id = '$reservationId' ";
                        ...
                        <form action="script.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="telephone" value="<?= $reservation['telephone']; ?>"class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>Tijd</label>
                                <input type="time" name="time" value="<?= $reservation['time']; ?>"class="form-control">
                                <p class="help is-danger">
                                    <?= $errors['time'] ?? '' ?>
                                </p>
                            </div>
                            <div class="mb-3">
                                <label>datum</label>
                                <input type="date" name="date" value="<?= $reservation['date']; ?>" class="form-control">
                                <p class="help is-danger">
                                    <?= $errors['date'] ?? '' ?>
                                </p>
                            </div>
                            <div class="form-element">
                                ...
                                <select id="treatment-id" name="treatment-id" placeholder="Vul de behandeling in"><br>
